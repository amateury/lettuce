...
(function (TypesErrorCompare) {
    ...
    TypesErrorCompare["compareValidate"] = "compareValidate";
...
var compareValidate = function (compare, val, values) { return __awaiter(void 0, void 0, void 0, function () {
    var valid;
    return __generator(this, function (_a) {
        valid = compare(val, values);
        if (!valid)
            error(TypesErrorCompare.compareValidate);
        return [2 /*return*/];
    });
}); };
/**
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    ...
                    _a.label = 6;
                case 6:
                    if (!(scheme.compare && valIsValid)) return [3 /*break*/, 12];
                ...
                case 9:
                    ...
                    _a.label = 10;
                case 10:
                    if (!(scheme.compare.validate && valIsValid)) return [3 /*break*/, 12];
                    return [4 /*yield*/, compareValidate(scheme.compare.validate, val, values).catch(callBack)];
                case 11:
                    _a.sent();
                    _a.label = 12;
                case 12: return [2 /*return*/, val];
            }
        });
    });
}
